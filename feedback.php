...
<div class="row1">
<h1 class="title"><span>Give Feedback </span></h1>

<strong>Enter the details!!!<br>
<br>
</p>
</div>
<div class="row2">
...
<form action="feedbackphp.php" method="post">
                  <label><h1>Give Feedback</h1></label>
                  <br/>
                  <label>First name :</label><input type="text" name="firstname" placeholder="First name" class="box" required /><br/>
                  <br/>
                  <label>Last name  :</label><input type="text" name="lastname" placeholder="Last Name" class="box" required /><br/>
                  <br/>
                  <label>Phone no  :</label><input type = "text" name = "phone" placeholder="Phone no" class = "box" required /><br /><br />
                  <label>Comment :</label><input type = "text" name = "comment" placeholder="Comment" maxlength="10" class = "box" required /><br/><br />
