...
<div class="row1">
<h1 class="title">You have successfully registered in!!!<span>DJ NIGHT </span></h1>
...
<p><?php
      ...
      $query=mysql_query("call dj2()");
      $row=mysql_fetch_array($query);
      echo "TOTAL NO OF STUDENTS PARTICIPATED IN DJ NIGHT ARE:  ";
      echo $row[0];  
?></p>
<p>&nbsp;</p>
<br><br>
