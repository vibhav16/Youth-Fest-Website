...
<div class="row1">
<h1 class="title">You have successfully registered in!!!<span>FUNNY GAMES </span></h1>
...
<p><?php
      ...
      $query=mysql_query("call funny1()");
      $row=mysql_fetch_array($query);
      echo "TOTAL NO OF STUDENTS PARTICIPATED IN FUNNY GAMES ARE:  ";
      echo $row[0];  
?></p>
<p>&nbsp;</p>
<br>
