...
<head>
  <meta charset="UTF-8">
  <title>Impressions REGISTER</title>
...
<div class="row1">
<h1 class="title"><span>FUNNY GAMES </span></h1>

<strong>Register for FUNNY GAMES<br>
<br>
</p>
</div>
<div class="row2">
<p>
<form action="funnyphp.php" method="post">
                  <label><h1>REGISTER</h1></label>
                  <label>FIRST NAME:</label><input type="text" name="firstname" placeholder="Id" class="box" required /><br/>
                  <br/>
                  <label>LAST NAME :</label><input type="text" name="lastname" placeholder="Name" class="box" required /><br/>
                  <br/>
                  <label>PHONE  :</label><input type = "text" name = "phone" placeholder="UserName" class = "box" required /><br /><br />
                  <label>EMAIL :</label><input type = "text" name = "email" placeholder="UserName" class = "box" required /><br /><br />
                  <label>COLLEGE  :</label><input type = "text" name = "college" placeholder="UserName" class = "box" required /><br /><br />
